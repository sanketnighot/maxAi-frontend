...
// Dummy data
const dummyAnalysis: PortfolioAnalysis = {
  tokens: [
    { name: "Bitcoin", symbol: "BTC", value: 25000 },
    { name: "Ethereum", symbol: "ETH", value: 15000 },
    { name: "Binance Coin", symbol: "BNB", value: 8000 },
    { name: "Cardano", symbol: "ADA", value: 5000 },
    { name: "Solana", symbol: "SOL", value: 3500 },
    { name: "Polkadot", symbol: "DOT", value: 2000 },
    { name: "Avalanche", symbol: "AVAX", value: 1500 },
    { name: "Chainlink", symbol: "LINK", value: 1000 },
    { name: "Uniswap", symbol: "UNI", value: 800 },
    { name: "Aave", symbol: "AAVE", value: 600 },
  ],
};
...
export function MarketCapAnalysis({
  ...
  if (analysis.tokens.length > 7) {
    ...
    const totalValue = analysis.tokens.reduce(
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg space-y-8">
      ...
      <div className="pt-6 mt-6 border-t border-gray-200 dark:border-gray-700">
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Portfolio market cap distribution showing relative proportions of each
          asset, helping visualize portfolio composition and concentration.
        </p>
      </div>
    </div>
  );
